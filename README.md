...
{background-color:$bg-grey-6x}
table[class*="table-striped-"] > tbody > tr.bg-stable
{background-color:$bg-stable}
table[class*="table-striped-"] > tbody > tr.bg-positive
{background-color:$bg-positive}
table[class*="table-striped-"] > tbody > tr.bg-calm
{background-color:$bg-calm}
table[class*="table-striped-"] > tbody > tr.bg-balanced
{background-color:$bg-balanced}
table[class*="table-striped-"] > tbody > tr.bg-energized
{background-color:$bg-energized}
table[class*="table-striped-"] > tbody > tr.bg-assertive
{background-color:$bg-assertive}
table[class*="table-striped-"] > tbody > tr.bg-royal
{background-color:$bg-royal}
table[class*="table-striped-"] > tbody > tr.bg-dark
{background-color:$bg-dark}
